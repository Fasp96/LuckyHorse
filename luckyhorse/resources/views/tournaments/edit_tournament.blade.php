...
<!-- JS files to validate all fields, get tournament and use api for location-->
...
<!-- Container of the form to edit a tournament -->
<div class="container">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">                    
                    ...
                    <!-- Form filled with the corresponding values to edit a tournament -->
...
<!-- JS file to get tournament races-->
